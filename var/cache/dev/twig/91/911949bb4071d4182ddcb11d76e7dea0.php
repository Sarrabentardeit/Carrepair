...
/* user/show.html.twig */
class __TwigTemplate_99a6e40081e1cfe38a11f437cb6c3154 extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 36
        yield ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 36, $this->source); })()), "roles", [], "any", false, false, false, 36)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(json_encode(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 36, $this->source); })()), "roles", [], "any", false, false, false, 36)), "html", null, true)) : (""));
        yield "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "user/show.html.twig", "C:\\xampp\\htdocs\\Carservice-main\\templates\\user\\show.html.twig");
    }
}

...
class __TwigTemplate_2706b200a8580adf811688da03c497db extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        yield "</p>
                        <p><strong>Montant Total des Articles :</strong> <span class=\"text-dark font-weight-bold\">";
        // line 42
        ...
        yield " TND</span></p>
                        <p><strong>Frais de Livraison :</strong>
                            ";
        // line 44
        if ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 44, $this->source); })()), "typeLivraison", [], "any", false, false, false, 44) == "Livraison Aramex")) {
            // line 45
            yield "                                8 TND
                            ";
        } else {
        ...
        yield "                        </p>
            ...
            ";
        // line 52
        if ((CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 52, $this->source); })()), "typeLivraison", [], "any", false, false, false, 52) == "Livraison Aramex")) {
            // line 53
            yield "                ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 53, $this->source); })()), "montantTotal", [], "any", false, false, false, 53) + 8), "html", null, true);
            yield " TND
            ";
        } else {
            // line 55
            yield "                ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 55, $this->source); })()), "montantTotal", [], "any", false, false, false, 55), "html", null, true);
            yield " TND
            ";
        }
        // line 57
        ...
        // line 59
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 59, $this->source); })()), "typeLivraison", [], "any", false, false, false, 59), "html", null, true);
        yield "</p>
                        <p><strong>Mode de Paiement :</strong> Paiement lors de la livraison</p>
                        <p><strong>Statut :</strong> <span class=\"text-warning\">";
        // line 61
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 61, $this->source); })()), "statut", [], "any", false, false, false, 61), "html", null, true);
        yield "</span></p>
                    </div>
...
";
    ...
    {
        return array (  211 => 61,  206 => 59,  202 => 57,  196 => 55,  190 => 53,  188 => 52,  183 => 49,  179 => 47,  175 => 45,  173 => 44,  168 => 42,  164 => 41,  160 => 40,  147 => 29,  138 => 26,  132 => 25,  128 => 24,  125 => 23,  121 => 22,  106 => 10,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }

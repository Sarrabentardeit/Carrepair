 ...
 */
class getVehiculeCompatibleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VehiculeCompatibleRepository' shared autowired service.
     *
     * @return \App\Repository\VehiculeCompatibleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VehiculeCompatibleRepository.php';

        return $container->privates['App\\Repository\\VehiculeCompatibleRepository'] = new \App\Repository\VehiculeCompatibleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

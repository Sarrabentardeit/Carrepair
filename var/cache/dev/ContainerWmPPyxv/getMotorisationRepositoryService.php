 ...
 */
class getMotorisationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MotorisationRepository' shared autowired service.
     *
     * @return \App\Repository\MotorisationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MotorisationRepository.php';

        return $container->privates['App\\Repository\\MotorisationRepository'] = new \App\Repository\MotorisationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

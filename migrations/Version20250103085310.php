 ...
 */
final class Version20250103085310 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE modele_motorisation (modele_id INT NOT NULL, motorisation_id INT NOT NULL, INDEX IDX_CE834696AC14B70A (modele_id), INDEX IDX_CE834696A3B5A725 (motorisation_id), PRIMARY KEY(modele_id, motorisation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');

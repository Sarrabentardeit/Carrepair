 ...
 */
final class Version20250114114826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vehicule_compatible DROP FOREIGN KEY FK_970EEAD54584665A');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vehicule_compatible (id INT AUTO_INCREMENT NOT NULL, marque_id INT NOT NULL, modele_id INT NOT NULL, motorisation_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_970EEAD5AC14B70A (modele_id), INDEX IDX_970EEAD5A3B5A725 (motorisation_id), INDEX IDX_970EEAD54584665A (product_id), INDEX IDX_970EEAD54827B9B2 (marque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE vehicule_compatible ADD CONSTRAINT FK_970EEAD54584665A FOREIGN KEY (product_id) REFERENCES product (id)');
    }
}
